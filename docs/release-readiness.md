...
- Versioned HTTP service with request IDs, optional namespace authorization, health/readiness, evidence/job inspection, and OpenAPI generation with a contract test.
...
- 100 automated tests pass with Ruff and mypy.
